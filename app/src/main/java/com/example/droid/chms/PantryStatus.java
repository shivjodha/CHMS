...
import Adapter.PantryStatusAdapter;
import Adapter.RoomHistoryAdapter;
import Adapter.RoomHistoryModel;

public class PantryStatus extends AppCompatActivity {


    private RecyclerView recyclerView;
    private ArrayList<RoomHistoryModel> albumList;
    private PantryStatusAdapter adapter;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pantry_status);
        getSupportActionBar().setTitle("Pantry Status");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);

        albumList = new ArrayList<>();
        adapter = new PantryStatusAdapter(PantryStatus.this, albumList);
