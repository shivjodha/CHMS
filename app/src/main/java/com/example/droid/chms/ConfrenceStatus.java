...
import Adapter.ConfrencestatusAdapter;
import Adapter.RoomHistoryAdapter;
import Adapter.RoomHistoryModel;

public class ConfrenceStatus extends AppCompatActivity {
    private RecyclerView recyclerView;
    private ArrayList<RoomHistoryModel> albumList;
    private ConfrencestatusAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_confrence_status);
        getSupportActionBar().setTitle("Confrence Status");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);

        albumList = new ArrayList<>();
        adapter = new ConfrencestatusAdapter(ConfrenceStatus.this, albumList);
